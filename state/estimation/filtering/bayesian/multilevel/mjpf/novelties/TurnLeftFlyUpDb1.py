...
class TurnLeftFlyUpDb1(TurnLeftFlyUp):
    ...
    def _getNormalNoveltyValueByTimeStep(self, timeStep: int):
        ...
        value = 0.05 * np.sin(timeStep / 200) \
    ...
    def getNoveltyValues(self):
        for timeStep in self._getTimeStepValues():
            ...
            if timeStep > 233 and timeStep < 666:
                self._noveltyValues.append(0.25 + timeStep / 233 + self._noveltyComputer.getNoveltyValue())
            # novelty
            ...
            # Little before novelty
            elif timeStep > (3000-333) and timeStep < (3000+333):
                self._noveltyValues.append(0.25 + timeStep / (3000+333) + self._noveltyComputer.getNoveltyValue())
            # novelty
            elif timeStep > (3000+333) and timeStep < (3000+666):
                self._noveltyValues.append(1 + timeStep / (3000+333) + self._noveltyComputer.getNoveltyValue())
            # little after novelty
            elif timeStep > (3000+666) and timeStep < (3000+1333):
                self._noveltyValues.append(2.2 - timeStep / (3000+999) + self._noveltyComputer.getNoveltyValue())
            # out of novelty
            else:
